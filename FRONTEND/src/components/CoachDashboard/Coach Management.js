...
//   useEffect(() => {
//     // Function to fetch pending coaches
//     const fetchPendingCoaches = async () => {
//       try {
//         const response = await fetch('http://localhost:2003/api/admin/coaches/pending'); // Corrected URL
//         if (!response.ok) {
...
//         // console.error('Error fetching pending coaches:', error);
//         setError('Failed to load pending coaches. Please try again later.');
//       }
//     };
...
//       setPendingCoaches(pendingCoaches.filter(coach => coach._id !== id));
//     } catch (error) {
//       // Handle and log errors during approval process
//       console.error('Error updating coach status:', error);
//     }
//   };
